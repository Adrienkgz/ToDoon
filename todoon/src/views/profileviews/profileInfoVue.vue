<template>
    <div class="mx-4 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-auto">
        ...
        <div class="grid grid-cols-8 pt-3 sm:grid-cols-10">
            ...
            <label for="select-1" class="flex w-full cursor-pointer select-none rounded-lg border p-2 px-3 text-sm text-gray-700 ring-pinky peer-checked:ring">Profile </label>
            ...
            <ul>
                ...
                <li class="mt-5 cursor-pointer border-l-2 border-l-pinky px-2 py-2 font-semibold text-pinky transition hover:border-l-pinky hover:text-pinky" @click="changeView('profile')">Profile</li>
