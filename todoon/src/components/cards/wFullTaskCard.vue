          ...
          <div class="flex flex-col flex-grow items-start">
            <div class="h-30"></div>
              ...
              <div class="flex space-x-2">
                <button class="edit-button" onclick="my_modal_5.showModal">
                ...
                <button class="delete-button" onclick="deleteconfirmation.showModal">
      ...
      <div class="modal-box w-11/12 max-w-5xl">
        ...
        <div class="flex space-x-5 mt-5">
          ...
          <label class="form-control w-full max-w-xs">
            ...
            <input type="date" placeholder="Type here" class="input input-bordered w-full max-w-xs" id='date' v-model="newTask.taskenddate" required/>
          </label>
          <label class="form-control w-full max-w-xs">
            <div class="label">
