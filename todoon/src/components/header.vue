<template>
    ...
    <img src="../img/logo-pasteque-bg-removed.png" alt="Logo" class="w-151 h-104">
    <nav class="hidden md:flex space-x-20">
      ...
      <a href="#" class="font-black hover:text-gray-600">Contact Us</a>
    </nav>
    <div class="flex justify-end flex-grow space-x-4 ">
      ...
      <button class="font-black rounded-3xl py-0 px-10" style="background-color: #FF4785;">Login</button>
    </div>
  </header>
</template>