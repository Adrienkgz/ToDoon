<template>
    <div class="mx-4 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-auto">
        ...
        <div class="grid grid-cols-8 pt-3 sm:grid-cols-10">
            ...
            <label for="select-1" class="flex w-full cursor-pointer select-none rounded-lg border p-2 px-3 text-sm text-gray-700 ring-blue-700 peer-checked:ring">Settings </label>
            ...
            <ul>
                ...
                <li class="mt-5 cursor-pointer border-l-2 border-l-blue-700 px-2 py-2 font-semibold text-blue-700 transition hover:border-l-blue-700 hover:text-blue-700" @click="changeView('settings      ')">Settings</li>
            </ul>
            </div>
