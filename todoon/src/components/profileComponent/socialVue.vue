<template>
    <div class="mx-4 max-w-screen-xl sm:mx-8 xl:mx-auto">
        ...
        <div class="grid grid-cols-8 pt-3 pb-10 sm:grid-cols-10">
            ...
            <label for="select-1" class="flex w-full cursor-pointer select-none rounded-lg border p-2 px-3 text-sm text-gray-700 ring-blue-700 peer-checked:ring">Social </label>
            ...
            <ul>
                <li class="mt-5 cursor-pointer border-l-2 border-l-blue-700 px-2 py-2 font-semibold text-blue-700 transition hover:border-l-blue-700 hover:text-blue-700" @click="changeView('social')">Social</li>
                <li class="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700" @click="changeView('profile')">Profile</li>
            ...
            <hr class="mt-4 mb-8" />
            <p class="py-2 text-xl font-semibold">Social</p>
            <div class="space-y-2">
